...
REM
REM Generated by Vivado on Fri Sep 01 17:50:18 +0800 2023
...
echo "xvlog --incr --relax -prj OpenMIPS_tb_vlog.prj"
call xvlog  --incr --relax -prj OpenMIPS_tb_vlog.prj -log xvlog.log
